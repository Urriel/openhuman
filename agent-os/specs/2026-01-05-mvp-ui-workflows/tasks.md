...
- [ ] 1.0 Complete labels database layer
  - [ ] 1.1 Write 2-8 focused tests for labels functionality
  ...
  - [ ] 1.2 Create migration for message_labels table
  ...
  - [ ] 1.5 Create Tauri command for archive operation
...
- [ ] 2.0 Complete app shell and sidebar
  - [ ] 2.1 Write 2-8 focused tests for app shell components
  ...
  - [ ] 2.2 Install and configure Vue Tiptap
  ...
  - [ ] 2.3 Create AppShell.vue component
  ...
  - [ ] 2.4 Create Sidebar.vue component using shadcn-vue sidebar-07 pattern
  ...
  - [ ] 2.5 Create FolderItem.vue and LabelItem.vue components
  ...
  - [ ] 2.6 Ensure app shell tests pass
...
- [ ] 3.0 Complete email list and reader
  - [ ] 3.1 Write 2-8 focused tests for list and reader components
  ...
  - [ ] 3.2 Create EmailList.vue component
  ...
  - [ ] 3.3 Create EmailListItem.vue slot component
  ...
  - [ ] 3.4 Create EmailReader.vue component
  ...
  - [ ] 3.5 Create EmailReaderToolbar.vue component
  ...
  - [ ] 3.6 Create Tauri command list_messages
  ...
  - [ ] 3.7 Ensure list and reader tests pass
...
- [ ] 4.0 Complete composer and search
  - [ ] 4.1 Write 2-8 focused tests for composer and search
  ...
  - [ ] 4.2 Create EmailComposer.vue component (full-page view)
  ...
  - [ ] 4.3 Create AttachmentUpload.vue component
  ...
  - [ ] 4.5 Create SearchBar.vue component
  ...
  - [ ] 4.6 Implement search result highlighting
  ...
  - [ ] 4.7 Ensure composer and search tests pass
...
- [ ] 5.0 Complete integration testing and polish
  ...
  - [ ] 5.2 Analyze test coverage gaps for MVP UI + Workflows
  ...
  - [ ] 5.4 UI/UX polish and responsive design
  ...
  - [ ] 5.6 Run feature-specific tests
