...
A modern, keyboard-first email client built with Tauri 2, Vue 3, and TypeScript. Supports IMAP/SMTP protocols for multi-folder synchronization and bidirectional state management.
